/**
 * CONSUMER-UIUX-1 §5 — Myanmar chrome slots for Home (mobile).
 * F50: CCO authors every value. This file is created empty-but-typed —
...
export type CopyMyKey = keyof typeof copyMy;
